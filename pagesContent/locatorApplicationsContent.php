      ...
      <div class="col-12">
        ...
        <div class="card">
          ...
          <div class="card-body table-responsive p-0">
            <table class="table table-hover text-nowrap" id="permitsTable">
              <thead>
                <tr>
                  <th>Permit</th>
                  <th>Date &amp; Time</th>
              ...
              <tbody>
                <tr>
                  <td class="permit">PRMT-00123</td>
                  <td class="datetime">2025-08-29 09:30</td>
                  <td class="description">Building permit for kiosk installation.</td>
                  <td class="status">Approved</td>
                  <td>
                    <button class="btn btn-sm btn-secondary viewBtn" data-toggle="modal" data-target="#viewModal">
                        <i class="fas fa-eye"></i>
                    </button>
                  </td>
                </tr>
                <tr>
                  <td class="permit">PRMT-00456</td>
                  <td class="datetime">2025-08-29 14:00</td>
                  <td class="description">Electrical permit for store wiring.</td>
                ...
                <tr>
                  <td class="permit">PRMT-00789</td>
                  <td class="datetime">2025-08-28 10:15</td>
                  <td class="description">Plumbing permit for restroom renovation.</td>
                ...
                <tr>
                  <td class="permit">PRMT-01011</td>
                  <td class="datetime">2025-08-27 16:45</td>
                  <td class="description">Occupancy permit for office expansion.</td>
                  <td class="status">Approved</td>
                  <td>
                    <button class="btn btn-sm btn-secondary viewBtn" data-toggle="modal" data-target="#viewModal">
                        <i class="fas fa-eye"></i>
                ...
                <tr>
                  <td class="permit">PRMT-01555</td>
                  <td class="datetime">2025-08-26 08:00</td>
                  <td class="description">Fire safety inspection permit for warehouse.</td>
                  <td class="status">Pending</td>
                  <td>
                    <button class="btn btn-sm btn-secondary viewBtn" data-toggle="modal" data-target="#viewModal">
                        <i class="fas fa-eye"></i>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="viewModalLabel">Permit Details</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <p><strong>Permit:</strong> <span id="viewPermit"></span></p>
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll(".viewBtn").forEach(btn => {
      btn.addEventListener("click", function () {
        ...
        document.getElementById("viewPermit").innerText = row.querySelector(".permit").innerText;
        document.getElementById("viewDatetime").innerText = row.querySelector(".datetime").innerText;
        document.getElementById("viewDescription").innerText = row.querySelector(".description").innerText;
        document.getElementById("viewStatus").innerText = row.querySelector(".status").innerText;
      });
    });
  });
</script>
