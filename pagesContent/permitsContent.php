...
<!------------------ Main row -->
  ...
  <div class="content">
    <div class="container-fluid">
      <div class="shadow col-8 offset-2">
      <div class="card card-primary mt-4">
        <div class="card-header">
            <form action="uploadrequirements.php" method="get">
          <h3 class="card-title">JHMC Permit Application Form</h3>
        </div>
        <form>
          <div class="card-body">
            ...
            <!-- Dropdown Permit Selection -->
            <div class="form-group">
              <label for="permitType">Permit Type</label>
              <select id="permitType" class="form-control select2bs4" style="width: 100%;">
                ...
                <option value="zoning">Zoning/Locational Clearance</option>
                <option value="fire">Fire Safety Inspection Certificate</option>
                <option value="environmental">Environmental Compliance</option>
                <option value="gate Pass">Gate Pass</option>
              </select>
            </div>

            <!-- Multi-select (Optional, if applicant needs more than one) -->
            <div class="form-group d-none">
              <label for="multiplePermits">Other Required Permits</label>
              <select id="multiplePermits" class="form-control select2bs4" multiple="multiple" data-placeholder="Select additional permits" style="width: 100%;">
                <option value="building">Building Permit</option>
                <option value="occupancy">Occupancy Permit</option>
                <option value="business">Business Permit</option>
                <option value="electrical">Electrical Permit</option>
